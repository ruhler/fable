 ...
 *
 *  @sideeffects
 *   @i Allocates a new profile that should be freed with FbleFreeProfile()
 ...
 *
 *  @sideeffects
 *   @i Takes ownership of name, which will be freed when FbleFreeProfile() is
 *    called.
 */
 ...
 *
 *  @sideeffects
 *   @i Frees the memory resources associated with the given profile,
