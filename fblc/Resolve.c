...
static FblcTypeId ResolveExpr(Env* env, SName* names, Vars* vars, FblcExpr* expr, SVar** svars);
static FblcTypeId ResolveActn(Env* env, SName* names, Vars* vars, Vars* ports, FblcActn* actn, SVar** svars, SVar** sportv);

// AddVar --
