...
* Blank lines between blocks are treated as delimiters, the whitespace of
  those blank lines is ignored.
* Whitespace between ']' and the start of a same-line last argument is treated
  as a delimiter and otherwise ignored.
