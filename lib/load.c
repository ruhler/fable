 ...
 *
 * This is defined in a C file automatically generated by the build system
 * based on the configure installation directory options.
 */
extern const char* FbleDefaultPackagePath;
