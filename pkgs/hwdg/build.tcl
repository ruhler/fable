namespace eval "pkgs/hwdg" {
  ...
  testsuite $::out/pkgs/hwdg/Hwdg/tests.tr "$::out/pkgs/core/fble-stdio $::out/pkgs/hwdg/Hwdg/Tests.fble.d" \
    "$::out/pkgs/core/fble-stdio $cflags -m /Hwdg/Tests% --prefix Interpreted."
