namespace eval "pkgs/std" {
  ...
  test $::b/pkgs/std/fble-cli-demo.utf8.ucat.tr \
    ...
    "diff --strip-trailing-cr $::s/pkgs/std/utf-8.ucat.txt $::b/pkgs/std/fble-cli-demo.utf8.ucat.out"
  ...
  test $::b/pkgs/std/fble-cli-demo.utf8.cat.tr \
    ...
    "diff --strip-trailing-cr $::s/pkgs/std/utf-8.txt $::b/pkgs/std/fble-cli-demo.utf8.cat.out"
