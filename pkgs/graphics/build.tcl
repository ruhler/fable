namespace eval "pkgs/graphics" {
  ...
  pkg graphics [list std app] $::b/pkgs/graphics/Graphics/Usage.fble ""

  # /Graphics/Tests% interpreted
  set cflags "-I $::s/pkgs/graphics -I $::b/pkgs/graphics -I $::s/pkgs/app -I $::s/pkgs/std"
  run_cli_tests $::b/pkgs/graphics/tests-interpreted.tr "$cflags -m /Graphics/Tests%" $::b/pkgs/graphics/Graphics/Usage.fble
